      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
        ...
        >
          <span
            ...
            style={{ backgroundColor: 'rgba(37,99,235,0.25)', color: '#bfdbfe', border: '1px solid rgba(37,99,235,0.4)' }}
          >
        ...
        >
          Revolutionising <br />
          <span className="text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(to right, #2563EB, #60A5FA)' }}>
            Pet Care.
          </span>
        </motion.h1>
        ...
        >
          ...
          <Button
            ...
            style={{ background: 'linear-gradient(135deg, #2563EB, #60A5FA)', boxShadow: '0 8px 24px rgba(37,99,235,0.40)' }}
          >
